...
{ 
    ...
    if (error_buffer == NULL)
    {
		...
		strcpy(error_buffer, "ERROR: socker creation error\n");
		goto exit_error;
                                                  ...
                                                  &opt, sizeof(opt))) 
    {
		...
		strcpy(error_buffer, "ERROR: socket set options error\n");
		goto exit_error;
    } 
                                 ...
                                 sizeof(address))<0) 
    {
		...
		strcpy(error_buffer, "ERROR: invalid bind\n");
		goto exit_error;
    } 
    ...
    { 
		...
		strcpy(error_buffer, "ERROR: invalid accept\n");
		goto exit_error;
    } 

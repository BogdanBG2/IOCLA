...
{ 
	...
	strcpy(error_buffer, "ERROR: malloc error\n");
	goto exit_error;
    } 
    ...
    { 
		...
		strcpy(error_buffer, "ERROR: socket creation error\n");
   		goto exit_error;
	} 
    ...
    { 
		...
		strcpy(error_buffer, "ERROR: invalid adress error\n");
		goto exit_error;
    } 
    ...
    { 
		...
		strcpy(error_buffer, "ERROR: connection fail\n");
		goto exit_error;
